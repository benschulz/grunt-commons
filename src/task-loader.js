...
function pluginFor(taskId) {
    return {
        ...
        karma: ['chai', 'coveralls', 'grunt-karma', 'karma', 'karma-babel-preprocessor', 'karma-chai-plugins', 'karma-chrome-launcher', 'karma-coverage', 'karma-firefox-launcher', 'karma-html-reporter', 'karma-mocha', 'karma-phantomjs-launcher', 'karma-requirejs', 'simulant'],
